...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, VOTE_PROG, VOTE_VERS, vote_prog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (VOTE_PROG, VOTE_VERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, VOTE_PROG, VOTE_VERS, vote_prog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (VOTE_PROG, VOTE_VERS, tcp).");
		exit(1);
	}
